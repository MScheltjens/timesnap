...
export const Header = () => {
  ...
  return (
    <header className={`fixed font-light flex items-center w-full z-10 transition ease-in 0.5s linear text-white  ${scrollDirection === "down" ? "-translate-y-full" : scrollDirection === "up" ? "translate-y-0" : ""} bg-black bg-opacity-70 shadow-2xl shadow-gray-600`}>
